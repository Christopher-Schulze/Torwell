...
>
  ...
  <div class="grid grid-cols-4 gap-3">
    ...
    {#if isStopped}
      <button
        class="glass py-3 px-5 md:px-4 rounded-xl border-transparent font-medium flex items-center justify-center gap-2 cursor-pointer transition-all duration-300 ease-in-out text-sm bg-green-600/20 text-green-200 hover:bg-green-600/30 border border-green-500/30 transform hover:scale-105 min-h-[48px]"
    ...
    {:else if isConnecting}
      <button
        class="glass py-3 px-5 md:px-4 rounded-xl border-transparent font-medium flex items-center justify-center gap-2 transition-all duration-300 ease-in-out text-sm bg-yellow-600/20 text-yellow-400 border border-yellow-500/30 opacity-75 cursor-not-allowed min-h-[48px]"
        disabled={true}
      >
    ...
    {:else if isConnected}
      <button
        class="glass py-3 px-5 md:px-4 rounded-xl border-transparent font-medium flex items-center justify-center gap-2 cursor-pointer transition-all duration-300 ease-in-out text-sm bg-red-600/20 text-red-200 hover:bg-red-600/30 border border-red-500/30 transform hover:scale-105 min-h-[48px]"
    ...
    <!-- New Circuit Button -->
    <button
      class="glass-sm py-3 px-5 md:px-4 rounded-xl border-transparent font-medium flex items-center justify-center gap-2 transition-all duration-300 ease-in-out text-sm {isConnected &&
      !isCreatingCircuit
        ? 'bg-black/50 text-white hover:bg-black/60 cursor-pointer transform hover:scale-105'
        : 'bg-black/30 text-gray-400 cursor-not-allowed opacity-50'} min-h-[48px]"
    ...
    <!-- Logs Button -->
    <button
      class="glass-sm py-3 px-5 md:px-4 rounded-xl border-transparent font-medium flex items-center justify-center gap-2 cursor-pointer transition-all text-sm bg-black/50 text-white hover:bg-black/60 min-h-[48px]"
